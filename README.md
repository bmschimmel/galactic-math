...
3. Pick a game — **Galactic Math** or **Alien Invasion**
4. Pick your options: a game mode for Galactic Math (Standard, **Hyperspace**, **Kessel Run**) or how bad the invasion is for Alien Invasion
5. Check the Mission Briefing and hit **Begin Mission**
6. Type your answer and press **Enter**
7. Finish all 20 to see your rank and review any missed problems
